...
func file_exchange_exchange_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_exchange_exchange_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_exchange_exchange_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_exchange_exchange_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_exchange_exchange_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
